...
class FtpClient extends Plugin {
...
Log.e("","hello");
            ...
            if (action.equals("get")) {
				callbackId=get(filename, url);
System.out.println("hello" +callbackId);
            	//String[] mArray = callbackId.split(",");
            	//PluginResult.StatusMessages=mArray;
            }
...
* @throws IOException
*/
private String get(String filename, URL url) throws IOException {
		FTPClient f = setup(url);
